...
st.markdown("#:red[ ค่านวณค่าดัชนีมวลกาย BMI ❤️ ]")
...
if bmi <18.5:
  ...
  st.error("🩺 คุณอยู่ในเกณฑ์อ้วน ควรระวังเรื่องสุขภาพและการออกกำลังกาย (อ้วน)")

st.driver()
st.write("นางสาวธวัลปภัสสสร ศรีปาลวิทย์ ม.4/9 เลขที่26")
